    ...
    def to_code(self, state_method_name):
        ...
        def create_unordered_if_ladder(state_method):
            ...
            for signal in self._lookup[state_method]:
                ...
                if_ladder = If_Blob(
                    priority=priority, signal_name=signal_name, callback=fn_name
                )
        ...
        def fill_missing_ifs(ordered_ifs):
            ...
            if len(init) != 0:
                ...
                full_ordered_ifs.append(
                    If_Blob(
                        priority=init_priority, signal_name="INIT_SIGNAL", callback=None
                    )
                )
            ...
            if len(exit) != 0:
                ...
                full_ordered_ifs.append(
                    If_Blob(
                        priority=exit_priority, signal_name="EXIT_SIGNAL", callback=None
                    )
                )
